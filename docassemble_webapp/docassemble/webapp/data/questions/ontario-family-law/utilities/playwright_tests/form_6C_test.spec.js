/**
 * Playwright tests for Ontario Family Law Form 6C
 * Generated from YAML interview: generated_interviews/form_6C_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 6C: Form 6C
...
const testData = {
  ...
  '_including_travel_including_tr': '1000.00',
  'lawyerparalegals_name': 'Test Lawyer/paralegal’s name',
...
test.describe('Form 6C - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_6C.yml');
...
'] || 'Test Value');
    ...
    await page.fill('[name="_including_travel_including_tr"]', testData['_including_travel_including_tr'] || 'Test Value');
    await page.fill('[name="lawyerparalegals_name"]', testData['lawyerparalegals_name'] || 'Test Value');
    await page.fill('[name="street_address"]', testData['street_address'] || 'Test Value');
    await page.fill('[name="email_address"]', testData['email_address'] || 'Test Value');
    await page.click('button:has-text("Continue")');
    await page.waitForLoadState('networkidle');
...
test.describe('Form 6C - Field Validation', () => {
...
test.describe('Form 6C - Navigation', () => {
...
test.describe('Form 6C - Edge Cases', () => {
...
// Performance tests
test.describe('Form 6C - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 6C loaded in ${loadTime}ms`);
  });
});
