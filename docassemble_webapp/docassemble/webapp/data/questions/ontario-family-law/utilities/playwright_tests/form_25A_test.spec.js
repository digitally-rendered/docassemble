/**
 * Playwright tests for Ontario Family Law Form 25A
 * Generated from YAML interview: generated_interviews/form_25A_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 25A: Form 25A
...
const testData = {
  ...
  'judge_print_or_type_name': 'Test Judge (print or type name)',
  'date_of_order': '2024-01-01',
  'date': '2024-01-01',
  'name_or_names': 'Test name or names',
  'full_legal_names_of_spouses': 'Test full legal names of spouses',
  'place': 'Test place',
  'date_of_signature': '2024-01-01',
  'save_form': 'Test Save Form',
  'print_form': 'Test Print Form',
  'clear_form': 'Test Clear Form',
};
...
test.describe('Form 25A - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_25A.yml');
...
'] || 'Test Value');
    ...
    await page.fill('[name="judge_print_or_type_name"]', testData['judge_print_or_type_name'] || 'Test Value');
    await page.fill('[name="date_of_order"]', testData['date_of_order'] || '2024-01-01');
    await page.fill('[name="date"]', testData['date'] || '2024-01-01');
    await page.fill('[name="name_or_names"]', testData['name_or_names'] || 'Test Value');
    await page.fill('[name="full_legal_names_of_spouses"]', testData['full_legal_names_of_spouses'] || 'Test Value');
    await page.fill('[name="place"]', testData['place'] || 'Test Value');
    await page.fill('[name="date_of_signature"]', testData['date_of_signature'] || '2024-01-01');
    await page.fill('[name="save_form"]', testData['save_form'] || 'Test Value');
    await page.fill('[name="print_form"]', testData['print_form'] || 'Test Value');
    await page.fill('[name="clear_form"]', testData['clear_form'] || 'Test Value');
    await page.click('button:has-text("Continue")');
    await page.waitForLoadState('networkidle');
...
test.describe('Form 25A - Field Validation', () => {
...
test.describe('Form 25A - Navigation', () => {
...
test.describe('Form 25A - Edge Cases', () => {
...
// Performance tests
test.describe('Form 25A - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 25A loaded in ${loadTime}ms`);
  });
});
