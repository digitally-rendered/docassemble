/**
 * Playwright tests for Ontario Family Law Form 26
 * Generated from YAML interview: generated_interviews/form_26_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 26: Form 26
...
const testData = {
  ...
  'c_unpaid_lumpsum_debt_paragrap': '1000.00',
  'd_interest_on_unpaid_lumpsum_d': '1000.00',
};
...
test.describe('Form 26 - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_26.yml');
...
'] || 'Test Value');
    ...
    await page.fill('[name="c_unpaid_lumpsum_debt_paragrap"]', testData['c_unpaid_lumpsum_debt_paragrap'] || 'Test Value');
    await page.fill('[name="d_interest_on_unpaid_lumpsum_d"]', testData['d_interest_on_unpaid_lumpsum_d'] || 'Test Value');
    await page.click('button:has-text("Continue")');
    await page.waitForLoadState('networkidle');
...
test.describe('Form 26 - Field Validation', () => {
...
test.describe('Form 26 - Navigation', () => {
...
test.describe('Form 26 - Edge Cases', () => {
...
// Performance tests
test.describe('Form 26 - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 26 loaded in ${loadTime}ms`);
  });
});
