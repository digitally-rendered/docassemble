/**
 * Playwright tests for Ontario Family Law Form 8A
 * Generated from YAML interview: generated_interviews/form_8A_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 8A: Form 8A
...
test.describe('Form 8A - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_8A.yml');
...
test.describe('Form 8A - Field Validation', () => {
...
test.describe('Form 8A - Navigation', () => {
...
test.describe('Form 8A - Edge Cases', () => {
...
// Performance tests
test.describe('Form 8A - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 8A loaded in ${loadTime}ms`);
  });
});
