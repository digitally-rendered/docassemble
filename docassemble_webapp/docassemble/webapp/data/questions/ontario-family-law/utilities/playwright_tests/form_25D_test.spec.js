/**
 * Playwright tests for Ontario Family Law Form 25D
 * Generated from YAML interview: generated_interviews/form_25D_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 25D: Form 25D
...
const testData = {
  ...
  'the_sum_of_the_sum_of_the_sum_': '1000.00',
  '_': '1000.00',
  'spousal_support_in_the_amount_': '1000.00',
  'at_the_rate_of_at_the_rate_of_': '2024-01-01',
  'to_name_to_name_to_name_fixed_': '1000.00',
};
...
test.describe('Form 25D - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_25D.yml');
...
'] || 'Test Value');
    ...
    await page.fill('[name="the_sum_of_the_sum_of_the_sum_"]', testData['the_sum_of_the_sum_of_the_sum_'] || 'Test Value');
    await page.fill('[name="_"]', testData['_'] || 'Test Value');
    await page.fill('[name="spousal_support_in_the_amount_"]', testData['spousal_support_in_the_amount_'] || 'Test Value');
    await page.fill('[name="at_the_rate_of_at_the_rate_of_"]', testData['at_the_rate_of_at_the_rate_of_'] || '2024-01-01');
    await page.fill('[name="to_name_to_name_to_name_fixed_"]', testData['to_name_to_name_to_name_fixed_'] || 'Test Value');
    await page.click('button:has-text("Continue")');
    await page.waitForLoadState('networkidle');
...
test.describe('Form 25D - Field Validation', () => {
...
test.describe('Form 25D - Navigation', () => {
...
test.describe('Form 25D - Edge Cases', () => {
...
// Performance tests
test.describe('Form 25D - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 25D loaded in ${loadTime}ms`);
  });
});
