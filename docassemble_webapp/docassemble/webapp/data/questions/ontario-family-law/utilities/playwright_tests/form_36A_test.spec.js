/**
 * Playwright tests for Ontario Family Law Form 36A
 * Generated from YAML interview: generated_interviews/form_36A_interview.yml
 * Generated on: 2025-09-05 13:25:01
 * 
 * Title: Form 36A: Form 36A
...
const testData = {
  ...
  'recipients_income_required_for': '1000.00',
};
...
test.describe('Form 36A - Main Flow', () => {
  test('Complete form with all required fields', async ({ page }) => {
    // Navigate to the interview
    await page.goto('/interview?i=docassemble.ontarioforms:data/questions/form_36A.yml');
...
'] || 'Test Value');
    ...
    await page.fill('[name="recipients_income_required_for"]', testData['recipients_income_required_for'] || 'Test Value');
    await page.click('button:has-text("Continue")');
    await page.waitForLoadState('networkidle');
...
test.describe('Form 36A - Field Validation', () => {
...
test.describe('Form 36A - Navigation', () => {
...
test.describe('Form 36A - Edge Cases', () => {
...
// Performance tests
test.describe('Form 36A - Performance', () => {
  test('Measure page load time', async ({ page }) => {
    ...
    console.log(`Form 36A loaded in ${loadTime}ms`);
  });
});
