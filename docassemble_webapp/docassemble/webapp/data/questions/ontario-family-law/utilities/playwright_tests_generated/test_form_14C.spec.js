/**
 * Playwright Test for Ontario Family Law Form 14C
 * Ontario Family Law Form 14C
...
// Test suite for Form 14C
test.describe('Form 14C - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_14C_complete.yml`);
    ...
    await fillFormSpecificFields_14C(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 14C Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 14C")')).toBeVisible();
  });
...
// Form-specific field tests for Form 14C
test.describe('Form 14C - Field Validations', () => {
});

// Helper functions for Form 14C
...
async function fillFormSpecificFields_14C(page) {
