/**
 * Playwright Test for Ontario Family Law Form 8
 * Ontario Family Law Form 8
...
// Test suite for Form 8
test.describe('Form 8 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${BASE_URL}/interview?i=docassemble.webapp:data/questions/ontario-family-law/form_8_complete.yml`);
    ...
    await fillFormSpecificFields_8(page);
    ...
    await expect(page.locator('button:has-text("Download Form 8")')).toBeVisible();
  });
...
// Form-specific field tests for Form 8
test.describe('Form 8 - Field Validations', () => {
...
async function fillFormSpecificFields_8(page) {
