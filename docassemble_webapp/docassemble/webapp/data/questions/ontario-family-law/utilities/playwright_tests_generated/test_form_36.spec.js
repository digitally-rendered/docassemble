/**
 * Playwright Test for Ontario Family Law Form 36
...
// Test suite for Form 36
test.describe('Form 36 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_36_complete.yml`);
    ...
    await fillFormSpecificFields_36(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 36 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 36")')).toBeVisible();
  });
...
// Form-specific field tests for Form 36
test.describe('Form 36 - Field Validations', () => {
...
async function fillFormSpecificFields_36(page) {
