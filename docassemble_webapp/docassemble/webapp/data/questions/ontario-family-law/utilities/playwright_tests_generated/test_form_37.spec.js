/**
 * Playwright Test for Ontario Family Law Form 37
 * Ontario Family Law Form 37
...
// Test suite for Form 37
test.describe('Form 37 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_37_complete.yml`);
    ...
    await fillFormSpecificFields_37(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 37 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 37")')).toBeVisible();
  });
...
// Form-specific field tests for Form 37
test.describe('Form 37 - Field Validations', () => {
});

// Helper functions for Form 37
...
async function fillFormSpecificFields_37(page) {
