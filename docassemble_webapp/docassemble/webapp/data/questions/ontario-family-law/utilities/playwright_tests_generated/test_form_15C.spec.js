/**
 * Playwright Test for Ontario Family Law Form 15C
 * Ontario Family Law Form 15C
...
// Test suite for Form 15C
test.describe('Form 15C - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_15C_complete.yml`);
    ...
    await fillFormSpecificFields_15C(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 15C Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 15C")')).toBeVisible();
  });
...
// Form-specific field tests for Form 15C
test.describe('Form 15C - Field Validations', () => {
...
async function fillFormSpecificFields_15C(page) {
