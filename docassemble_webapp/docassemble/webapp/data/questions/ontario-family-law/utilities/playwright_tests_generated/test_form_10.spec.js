/**
 * Playwright Test for Ontario Family Law Form 10
 * Ontario Family Law Form 10
...
// Test suite for Form 10
test.describe('Form 10 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_10_complete.yml`);
    ...
    await fillFormSpecificFields_10(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 10 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 10")')).toBeVisible();
  });
...
// Form-specific field tests for Form 10
test.describe('Form 10 - Field Validations', () => {
...
async function fillFormSpecificFields_10(page) {
