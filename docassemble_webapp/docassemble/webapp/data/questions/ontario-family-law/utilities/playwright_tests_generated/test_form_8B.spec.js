/**
 * Playwright Test for Ontario Family Law Form 8B
 * Ontario Family Law Form 8B
...
// Test suite for Form 8B
test.describe('Form 8B - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_8B_complete.yml`);
    ...
    await fillFormSpecificFields_8B(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 8B Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 8B")')).toBeVisible();
  });
...
// Form-specific field tests for Form 8B
test.describe('Form 8B - Field Validations', () => {
...
async function fillFormSpecificFields_8B(page) {
