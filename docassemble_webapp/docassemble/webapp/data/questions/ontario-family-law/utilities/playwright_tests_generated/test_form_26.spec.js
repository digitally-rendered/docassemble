/**
 * Playwright Test for Ontario Family Law Form 26
 * Ontario Family Law Form 26
...
// Test suite for Form 26
test.describe('Form 26 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_26_complete.yml`);
    ...
    await fillFormSpecificFields_26(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 26 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 26")')).toBeVisible();
  });
...
// Form-specific field tests for Form 26
test.describe('Form 26 - Field Validations', () => {
});

// Helper functions for Form 26
...
async function fillFormSpecificFields_26(page) {
