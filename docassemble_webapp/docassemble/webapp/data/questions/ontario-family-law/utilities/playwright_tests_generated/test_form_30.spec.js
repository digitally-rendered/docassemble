/**
 * Playwright Test for Ontario Family Law Form 30
 * Ontario Family Law Form 30
...
// Test suite for Form 30
test.describe('Form 30 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_30_complete.yml`);
    ...
    await fillFormSpecificFields_30(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 30 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 30")')).toBeVisible();
  });
...
// Form-specific field tests for Form 30
test.describe('Form 30 - Field Validations', () => {
});

// Helper functions for Form 30
...
async function fillFormSpecificFields_30(page) {
