/**
 * Playwright Test for Ontario Family Law Form 27
 * Ontario Family Law Form 27
...
// Test suite for Form 27
test.describe('Form 27 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_27_complete.yml`);
    ...
    await fillFormSpecificFields_27(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 27 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 27")')).toBeVisible();
  });
...
// Form-specific field tests for Form 27
test.describe('Form 27 - Field Validations', () => {
});

// Helper functions for Form 27
...
async function fillFormSpecificFields_27(page) {
