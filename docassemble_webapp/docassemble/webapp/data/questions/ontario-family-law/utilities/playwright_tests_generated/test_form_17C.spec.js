/**
 * Playwright Test for Ontario Family Law Form 17C
 * Ontario Family Law Form 17C
...
// Test suite for Form 17C
test.describe('Form 17C - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_17C_complete.yml`);
    ...
    await fillFormSpecificFields_17C(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 17C Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 17C")')).toBeVisible();
  });
...
// Form-specific field tests for Form 17C
test.describe('Form 17C - Field Validations', () => {
...
async function fillFormSpecificFields_17C(page) {
