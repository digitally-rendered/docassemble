/**
 * Playwright Test for Ontario Family Law Form 6B
 * Ontario Family Law Form 6B
...
// Test suite for Form 6B
test.describe('Form 6B - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_6B_complete.yml`);
    ...
    await fillFormSpecificFields_6B(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 6B Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 6B")')).toBeVisible();
  });
...
// Form-specific field tests for Form 6B
test.describe('Form 6B - Field Validations', () => {
...
async function fillFormSpecificFields_6B(page) {
