/**
 * Playwright Test for Ontario Family Law Form 36A
 * Ontario Family Law Form 36A
...
// Test suite for Form 36A
test.describe('Form 36A - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_36A_complete.yml`);
    ...
    await fillFormSpecificFields_36A(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 36A Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 36A")')).toBeVisible();
  });
...
// Form-specific field tests for Form 36A
test.describe('Form 36A - Field Validations', () => {
...
async function fillFormSpecificFields_36A(page) {
