/**
 * Playwright Test for Ontario Family Law Form 25C
 * Ontario Family Law Form 25C
...
// Test suite for Form 25C
test.describe('Form 25C - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_25C_complete.yml`);
    ...
    await fillFormSpecificFields_25C(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 25C Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 25C")')).toBeVisible();
  });
...
// Form-specific field tests for Form 25C
test.describe('Form 25C - Field Validations', () => {
...
async function fillFormSpecificFields_25C(page) {
