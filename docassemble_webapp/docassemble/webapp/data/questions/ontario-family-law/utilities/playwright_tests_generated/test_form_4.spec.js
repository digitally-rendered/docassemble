/**
 * Playwright Test for Ontario Family Law Form 4
 * Ontario Family Law Form 4
...
// Test suite for Form 4
test.describe('Form 4 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_4_complete.yml`);
    ...
    await fillFormSpecificFields_4(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 4 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 4")')).toBeVisible();
  });
...
// Form-specific field tests for Form 4
test.describe('Form 4 - Field Validations', () => {
});

// Helper functions for Form 4
...
async function fillFormSpecificFields_4(page) {
