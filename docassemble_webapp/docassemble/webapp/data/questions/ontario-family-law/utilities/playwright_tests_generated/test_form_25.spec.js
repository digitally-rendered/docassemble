/**
 * Playwright Test for Ontario Family Law Form 25
 * Ontario Family Law Form 25
...
// Test suite for Form 25
test.describe('Form 25 - Complete Interview', () => {
  test.setTimeout(TIMEOUT);
  
  test('should complete the entire form with valid data', async ({ page }) => {
    // Navigate to the interview
    await page.goto(`${INTERVIEW_URL}/form_25_complete.yml`);
    ...
    await fillFormSpecificFields_25(page);
    
    // Continue through remaining questions
    await continueToEnd(page);
    
    // Verify we reached the final screen
    await expect(page.locator('h1')).toContainText('Form 25 Complete');
    
    // Verify download button is present
    await expect(page.locator('button:has-text("Download Form 25")')).toBeVisible();
  });
...
// Form-specific field tests for Form 25
test.describe('Form 25 - Field Validations', () => {
});

// Helper functions for Form 25
...
async function fillFormSpecificFields_25(page) {
